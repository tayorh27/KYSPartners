...
public class CategoryFragmentTab extends Fragment implements LogTypeCallback, View.OnClickListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        barChart.setDescription("Each category views chart");
    ...
    private ArrayList<BarDataSet> getDataSet(Map<String, Integer> _value) {
        ...
        BarDataSet barDataSet1 = new BarDataSet(valueSet1, "Category");
