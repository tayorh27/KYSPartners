...
import com.kys.kyspartners.Callbacks.LocationCallback;
...
import com.kys.kyspartners.network.UpdateShop;
...
public class ShopActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationCallback, LocationListener {
    ...
    EditText editDesc, editFull, editCity, editArea, editStrt, editNumber, editFrom, editTo;
    TextView editName;
    ...
    private void InitializeViews() {
        ...
        editName = (TextView) findViewById(R.id.shopName);
    ...
    private void LoadShopDetails() {
        ...
        String logo_url = shop.logo;
        imageUrl = logo_url;
        Glide.with(ShopActivity.this).load(logo_url.replace(" ", "%20")).centerCrop().fitCenter().placeholder(R.drawable.no_logo).into(logo);
        editName.setText(shop.name);
        editDesc.setText(shop.desc);
        editFull.setText(shop.full_add);
        editCity.setText(shop.city);
        editArea.setText(shop.area);
        editStrt.setText(shop.inside_area);
        editNumber.setText(shop.phone_number);
        editFrom.setText(shop.open);
        editTo.setText(shop.close);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        general = new General(ShopActivity.this);
        user = data.getUser();
        InitializeViews();
        LoadShopDetails();
    ...
    public void UpdateShop(View view) {
        ...
        if (tag.contentEquals("upload")) {
            ...
            floatingActionButton.setEnabled(false);
            UpdateShop updateShop = new UpdateShop(ShopActivity.this, myShop);
            updateShop.Update(fabProgressCircle, floatingActionButton, ShopActivity.this);
        }
    ...
    private void LocationSettingUp() {
        ...
        if (!isGPSEnabled) {
            new MaterialDialog.Builder(ShopActivity.this)
                    .title("GPS")
    ...
    private void displayLocation() {
        ...
        if (mLastLocation != null) {
            ...
            GetLocationFromServer getLocationFromServer = new GetLocationFromServer(ShopActivity.this, latitude, longitude, this);
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            if (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                ...
                Toast.makeText(ShopActivity.this, "This device is not supported", Toast.LENGTH_SHORT).show();
            }
            return false;
        }
        return true;
