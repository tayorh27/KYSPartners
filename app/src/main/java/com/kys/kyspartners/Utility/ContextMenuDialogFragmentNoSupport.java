...
public class ContextMenuDialogFragmentNoSupport extends DialogFragment implements OnItemClickListener, OnItemLongClickListener {

    public static final String TAG = ContextMenuDialogFragmentNoSupport.class.getSimpleName();
    ...
    @Deprecated
    public static ContextMenuDialogFragmentNoSupport newInstance(int actionBarSize, List<MenuObject> menuObjects) {
    ...
    @Deprecated
    public static ContextMenuDialogFragmentNoSupport newInstance(int actionBarSize, List<MenuObject> menuObjects, int animationDelay) {
        MenuParams params = new MenuParams();
        params.setActionBarSize(actionBarSize);
        params.setMenuObjects(menuObjects);
    ...
    @Deprecated
    public static ContextMenuDialogFragmentNoSupport newInstance(int actionBarSize, List<MenuObject> menuObjects, int animationDelay, int animationDuration) {
        MenuParams params = new MenuParams();
        params.setActionBarSize(actionBarSize);
        params.setMenuObjects(menuObjects);
        params.setAnimationDelay(animationDelay);
    ...
    public static ContextMenuDialogFragmentNoSupport newInstance(MenuParams menuParams) {
        ContextMenuDialogFragmentNoSupport fragment = new ContextMenuDialogFragmentNoSupport();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setStyle(STYLE_NO_FRAME, com.yalantis.contextmenu.lib.R.style.MenuFragmentStyle);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(com.yalantis.contextmenu.lib.R.layout.fragment_menu, container, false);
        ...
        if (mMenuParams.isClosableOutside()) {
            rootView.findViewById(com.yalantis.contextmenu.lib.R.id.root).setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    private void initViews(View view) {
        mWrapperButtons = (LinearLayout) view.findViewById(com.yalantis.contextmenu.lib.R.id.wrapper_buttons);
        mWrapperText = (LinearLayout) view.findViewById(com.yalantis.contextmenu.lib.R.id.wrapper_text);
    }
